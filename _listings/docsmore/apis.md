...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/flows/master/_listings/docsmore/apis.md
...
- name: Docsmore API 2.1 - Get All Document Flows
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/flows/master/_listings/docsmore/apidocflowgetdocflows-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/flows/master/_listings/docsmore/apidocflowgetdocflows-get-openapi.md
- name: Docsmore API 2.1 - Get All Document Flows
  x-api-slug: apidocflowgetdocflows-get
  description: Get all document flows.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/28946-api-docsmore-com.jpg
...
- name: Docsmore API 2.1 - Get Workflow Link For Flow Track
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/flows/master/_listings/docsmore/apidocflowtracksflowtrackviaapi-post-openapi.md
- name: Docsmore API 2.1 - Get Workflow Link For Flow Track
  x-api-slug: apidocflowtracksflowtrackviaapi-post
  description: |-
    In Docsmore space, Flow Track means all the client documents generated using one of the Document Flow. In other words, it is an instance of Document FLow. The other thing to notice here is payload information is remarkably similar to general "Workflow" of a Single Document.
